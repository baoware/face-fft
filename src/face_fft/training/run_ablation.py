...
def main():
    ...
    print(
        "| Architecture | Params | Time (s) | Accuracy | Precision | Recall | F1-Score | ROC-AUC |"
    )
    print(
        "|--------------|--------|----------|----------|-----------|--------|----------|---------|"
    )
    for arch, r in results.items():
        print(
            f"| {arch.upper():<12} | {r['Params']:<6} | {r['Time (s)']:<8} | {r['Acc']:.4f}   | {r['Prec']:.4f}    | {r['Rec']:.4f} | {r['F1']:.4f}   | {r['AUC']:.4f}  |"
        )
